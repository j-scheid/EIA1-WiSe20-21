...
function click() {
    ...
    var _loop_1 = function (f) {
        img[f].addEventListener("click", function () {
            //Berechnung
            var relative = (continents[f].e18 / total18 * 100).toFixed(2);
            var growthpercent = (continents[f].e18 / continents[f].e08 * 100 - 100).toFixed(2);
            var growthabsolute = (continents[f].e18 - continents[f].e08).toFixed(2);
