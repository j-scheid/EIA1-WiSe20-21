...
function prepareRecording() {
    ...
    for (var i_1 = recording.length - 1; i_1 >= 1; i_1--) {
        var prevTs = recording[i_1 - 1].timestamp;
        var ts = recording[i_1].timestamp;
        recording[i_1].timestamp = ts - prevTs;
    }
    recording[0].timestamp = recording[0].timestamp - recordingStartTimestamp;
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i_2 < recording.length)) return [3 /*break*/, 4];
